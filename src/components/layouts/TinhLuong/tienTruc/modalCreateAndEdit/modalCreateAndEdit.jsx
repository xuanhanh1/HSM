...
function ModalCreateAndEdit(props) {
  ...
  return (
    <div>
      <Modal
        title={isStatus === 0 ? t("Thêm tiền trực") : t("Sửa tiền trực")}
        visible={isVisible}
        width={"50vw"}
      ...
      >
        <form className="form" id="form" onSubmit={handleSubmit(onSubmit)}>
          <Row gutter={[8, 0]}>
            ...
            <Col span={12}>
              <Input label="Trực ngày thường" name={register("phone")} />
            </Col>
            <Col span={12}>
              <Input label="Trực thứ 7_cn" name={register("phone")} />
            </Col>
            <Col span={12}>
              <Input label="Trực ngày lễ tết" name={register("phone")} />
            </Col>
            <Col span={12}>
              <Input label="Hệ số TNT" name={register("phone")} />
            </Col>
            <Col span={12}>
              <Input label="Hệ số TTB_CN" name={register("phone")} />
            </Col>
            <Col span={12}>
              <Input label="Hệ số TLT" name={register("phone")} />
            </Col>
            <Col span={12}>
              <Input label="Đối tượng" name={register("phone")} />
            </Col>
            <Col span={12}>
              <Input label="Tổng ca" name={register("phone")} readOnly={true} />
            </Col>
            <Col span={12}>
              <Input
                label="Tổng tiền"
